...
Если вы уже используете XIVLauncher, то убедитесь в нём, что игра стоит на английском языке и Dalamud включён, и переходите сразу к [шагу 2](#install-penumbra).
...
![Установка XIVLauncher - 1](/assets/images/install-guide-1-01.png)

Под списком изменений нажмите **Assets** и загрузите установщик **Setup.exe**.

![Установка XIVLauncher - 2](/assets/images/install-guide-1-02.png)
...
![Установка XIVLauncher - 3](/assets/images/install-guide-1-03.png)
...
![Установка XIVLauncher - 4](/assets/images/install-guide-1-04.png)
...
![Установка XIVLauncher - 5](/assets/images/install-guide-1-05.png)

Поставьте галочку напротив **Включить Dalamud** и нажмите **Далее**.

![Установка XIVLauncher - 6](/assets/images/install-guide-1-06.png)
...
![Установка XIVLauncher - 7](/assets/images/install-guide-1-07.png)
...
![Установка XIVLauncher - 8](/assets/images/install-guide-1-08.png)
...
Если вы уже используете Penumbra, то переходите на [шаг 3](#import-modpack).
...
![Установка Penumbra - 1](/assets/images/install-guide-2-01.png)
...
![Установка Penumbra - 2](/assets/images/install-guide-2-02.png)
...
![Установка Penumbra - 3](/assets/images/install-guide-2-03.png)

В строке поиска начните вводить `penumbra`, выделите плагин и нажмите **Установить**.

![Установка Penumbra - 4](/assets/images/install-guide-2-04.png)
...
![Установка модпака - 1](/assets/images/install-guide-3-01.png)

Во вкладке **Settings** откройте опции **Advanced** и поставьте галочку напротив **Wait for Plugins on Startup**.

![Установка модпака - 2](/assets/images/install-guide-3-02.png)

Во вкладке **Mods** нажмите кнопку импорта модпака.

![Установка модпака - 3](/assets/images/install-guide-3-03.png)

В появившемся окне **укажите** на скачанный модпак.

![Установка модпака - 4](/assets/images/install-guide-3-04.png)

**Включите** модпак и **перезапустите** игру.

![Установка модпака - 5](/assets/images/install-guide-3-05.png)

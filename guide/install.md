...
Теперь требуется указать Penumbra, в какой папке будут находиться установленные моды. К расположению этой папки есть следующие требования:
* Путь должен быть как можно короче
...
Для простоты можно создать папку `FFXIVMods` в корне диска, на котором установлена игра.

Откройте настройки Penumbra любым из перечисленным выше способов. В первой вкладке нажмите **иконку папки** напротив **Root Directory**и в появившемся окне выберите созданную папку. 

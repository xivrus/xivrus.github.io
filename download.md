...
## Последняя версия --- 1.8.1 (для патча 7.2hf1) {#latest}
...
<details style="color: #d8d8d8">
  ...
  * Основной сюжет:
    ...
    * **Dawntrail** --- до задания Ур. 97 <<Ушедшие и забытые>> (*Gone and Forgotten*)
  * Хроники новой эры:
...
* Исправления в заданиях Хильдибранда
* Исправления в строках интерфейса
* **Текстуры**:
  * Добавлены текстуры заданий Хильдибранда от _Tiny Skald_
...
[Зеркало](https://builds.xivrus.ru/releases/XIVRus-1.8.1-2025-04-03-16-56.pmp){: .site-masthead__button mx-2 mb-2}

...
## Последняя версия --- {{ latest_version }} (для патча 7.55hf2) {#latest}

**ВНИМАНИЕ!**\
Модификация временно недоступна для скачивания, пока мы не обновим её для новой версии игры **7.56**.
...
<details style="color: #d8d8d8">
  ...
  * Побочные задания:
    ...
    * Ла Ноша — весь регион
    * Таналан — только Уль'да, Центральный, Северный, Западный и Восточный
...
[Зеркало](https://builds.xivrus.ru/releases/XIVRus-1.19.0-2026-08-17-22-19.pmp){: .site-masthead__button mx-2 mb-2}

...
* **Добавлен улучшенный вариант стандартного шрифта кириллицы.**
  В модпаке теперь есть **настройка**, с помощью которой можно переключить шрифт. По умолчанию он **включён**.
  Шрифт отличается от встроенного в игру тем, что у кириллицы **чуть-чуть увеличено расстояние между буквами**, а для особо мелких размеров шрифта **исправлены скачущие буквы и прочие артефакты**. Затронута исключено кириллица --- абсолютно все остальные символы остались прежними. Новый вариант шрифта особенно рекомендован к использованию для тех, кто играет с маленькими и с большими разрешениями экрана.
